...
<?php
$cart_list = mysqli_query($connect, "select * from cart_id where Cart_status = 0 and Member_ID = '$memberid'");
...
?>			
                <tr class="ev">
                    ...
                    <td><a class="pay" href="Shipping.php?pay&code=<?php echo $list["Cart_ID"]; ?>"><span class="material-icons">attach_money</span></a></td>
					<td><a class="del" href="Payment.php?del&code=<?php echo $list["Cart_ID"]; ?>" onclick="return confirmation();"><span class="material-icons">delete</span></a></td>
				</tr>
                <?php
