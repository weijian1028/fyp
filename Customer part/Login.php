...
<div class="navbar">
 ...
 <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="Category.php">Cake</a>
      <a href="Category.php">Bread</a>
      <a href="Category.php">Tart</a>
	  <a href="Category.php">Others</a>
    </div>
  </div> 
...
<div id="box">
    ...
    <div id="form">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a class="ff" href="Register.php">Sign up now</a>.</p>
            <p>Forgot Password? <a class="ff" href="Forgot_password.php">Reset now</a>.</p>
        </form>
    </div> 
	</div>
</div>
